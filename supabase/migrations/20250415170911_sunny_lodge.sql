...
-- Fix performance_insights view
DROP VIEW IF EXISTS performance_insights;
CREATE VIEW performance_insights SECURITY INVOKER AS
...
-- Fix usage_aggregates view
DROP VIEW IF EXISTS usage_aggregates;
CREATE VIEW usage_aggregates SECURITY INVOKER AS
...
-- Fix usage_statistics view
DROP VIEW IF EXISTS usage_statistics;
CREATE VIEW usage_statistics SECURITY INVOKER AS
...
-- Fix trend_insights view
DROP VIEW IF EXISTS trend_insights;
CREATE VIEW trend_insights SECURITY INVOKER AS
WITH 
